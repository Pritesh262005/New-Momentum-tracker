  ...
  return (
    <div className="page-container">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Dashboard', path: '/student' }, { label: 'Profile' }]}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="card p-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4 text-sm">
            <div>
              <p className="font-bold text-lg text-[var(--primary)]">{user?.momentum || 0}</p>
              <p className="text-xs text-[var(--text-secondary)]">Momentum</p>
            </div>
            <div>
              <p className="font-bold text-lg text-[var(--primary)]">🔥 {user?.streak || 0}</p>
