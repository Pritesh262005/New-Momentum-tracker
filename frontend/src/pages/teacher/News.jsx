              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 text-xs" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <span className="px-2 py-1 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-500 text-white text-xs">
                      Department Students
                    </span>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="form-group">
          ...
          <div className="p-3 rounded-lg" style={{ backgroundColor: 'var(--bg-base)' }}>
            <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Department Students</span>
          </div>
        </div>
